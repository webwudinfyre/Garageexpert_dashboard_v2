                ...
                <div class="modal-dialog modal-lg  modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form
                                action="{{ route('admin.registration.profilecreatesocial', ['id' => encrypt($Adminusers->id)]) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="floatingwebsite">Instagram</label>
                                        @error('instagram')
                                            <div class="alert-color" role="alert">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <select class="form-select" id="floatinggender" name="Gender" required>
                                                <option value="@nullOrValuenostyle($Adminusers->Gender, 'Gender')" @if($Adminusers->Gender == '') selected @endif>@nullOrValuenostyle($Adminusers->Gender, 'Gender')</option>
                                                <option value="male" @if($Adminusers->Gender == 'male') selected @endif>Male</option>
                                                <option value="female" @if($Adminusers->Gender == 'female') selected @endif>Female</option>
                                            </select>
