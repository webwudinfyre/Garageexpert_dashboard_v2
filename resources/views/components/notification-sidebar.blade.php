...
@if (auth()->check() && auth()->user()->notifications->count() > 0)
    ...
    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
        ...
        @foreach (auth()->user()->notifications->reverse()  as $key => $notification)
                ...
                @if (empty($notification->read_at))
                    ...
                    <li class="notification-item">
                        ...
                        <div class="d-flex">
                            ...
                            <a
                                href="{{ route('admin.joballocation.mark_as_read', ['id' => encrypt($notification->id)]) }}"><span
                                    class="mark_as_read"> <i class="bi bi-envelope-paper"></i></span></a>
                        </div>
        ...
        <li class="dropdown-footer">
            <a href="{{ route('admin.joballocation.mark_as_read_all', ['id' => encrypt(Auth::user()->id)]) }}">Mark all
                Read</a>
        </li>
