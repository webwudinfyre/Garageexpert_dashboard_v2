                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-select" aria-label="Default select example" name="Task_value">
                                            ...
                                            <option value="{{ $item->id }} " {{ !empty($search_page) &&
                                                $search_page['Task_value']==$item->id ? 'selected' : '' }}>
                            ...
                            <div class="col-xxl-3 col-md-6 text-center ">
                                <div class="search">
                                    <div class="form-floating mb-3 ">
                                        <button type="submit" class="btn bg-primary_expert" style="height: 100%; width:50%">search</button>
                                    </div>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action_icon ">
                                                <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View" href="{{ route('tech.joballocation.job_list_view', ['id' => encrypt($prdt_task->product_id)]) }}">
                    ...
                    <form action="{{ route('tech.joballocation.job_assign')}}" method="GET">
                        <div id="assign_to" class="row">
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" name="pdt_id_name_assign" id="pdt_id_name_assign">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select class="form-select" id="Technician_name_assign" name="Technician_name_assign" required>
                            ...
                            ">
                                <div class="Confirm_assign d-flex " style="justify-content: space-around; align-items:center">
                                    <button type="submit" class="btn bg-primary_expert ">Confirm To Assign Job</button>
                                </div>
                            </div>
