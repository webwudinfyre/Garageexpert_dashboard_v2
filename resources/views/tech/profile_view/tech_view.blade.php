            ...
            <div class="modal-dialog modal-lg  modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form
                            action="{{ route('tech.registration.tech.profilecreatesocial', ['id' => encrypt($Adminusers->id)]) }}"
        ...
        <div class="modal fade" id="Basic_details" tabindex="-1" aria-labelledby="Basic_etails"
            ...
            <div class="modal-dialog modal-lg  modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form
                            action="{{ route('tech.registration.tech.profilebasic_details', ['id' => encrypt($Adminusers->id)]) }}"
