...
@section('contents')
            ...
            <div class="col-8  align-items-center ">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        @else
                        <li class="breadcrumb-item active"><a  href="{{ route('client.registration.clientprofile', ['id' => encrypt($Adminusers->suboffice)]) }}">{{ $officemain }} Profile </a></li>
                                                                ...
                                                                <td>
                                                                    <div class="action_icon ">
                                                                        <a data-bs-toggle="tooltip"
                                                                            ...
                                                                            href="{{ route('client.registration.clientprofile', ['id' => encrypt($data->id)]) }}">
                                                                        ...
                                                                        <a data-bs-toggle="tooltip"
                                                                            ...
                                                                            <button type="button" class="btn"
                                                                                ...
                                                                                data-bs-target="#Password_change_api"
                                                                        ...
                                                                        <a data-bs-toggle="tooltip"
                                                                            ...
                                                                            <button type="button" class="btn"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#Status_change_client"
                                                                                data-bs-whatever={{ $data->users->id }}>
                ...
                <div class="modal-dialog modal-lg  modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form
                                action="{{ route('client.registration.client.profilecreatesocial', ['id' => encrypt($Adminusers->id)]) }}"
            ...
            <div class="modal fade" id="Basic_details" tabindex="-1" aria-labelledby="Basic_etails"
                ...
                <div class="modal-dialog modal-lg  modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form
                                action="{{ route('client.registration.client.profilebasic_details', ['id' => encrypt($Adminusers->id)]) }}"
    ...
    <section class="view" id="view">
        <div class="modal fade" id="Password_change_api" tabindex="-1" aria-labelledby="Password_change_api"
            aria-hidden="true">
            <div class="modal-dialog modal-lg  modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('client.passwordupdate') }}" class="row g-3" method="POST">
    ...
    <section class="view" id="view">
        <div class="modal fade" id="Status_change_client" tabindex="-1" aria-labelledby="Status_change_client" aria-hidden="true">
            <div class="modal-dialog modal-lg  modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('client.updateStatus') }}" class="row g-3" method="POST">
        ...
        <div class="modal fade" id="add_sub_office_profile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('client.registration.clientcreate.suboffice',['id' => encrypt($Adminusers->id)]) }}" class="row g-3" method="POST">
                            @csrf
