...
class DashboardController extends Controller
{
    function index(): View
    {
        ...
        $task2 = product_task::with(['Type_service', 'task', 'users_pdt', 'product_add', 'product_add.client_pdt'])->latest()
            ->take(5)
            ->get();

        foreach ($task2 as $key => $task_review) {
        ...
        $client_latest = product_task::with(['Type_service', 'product_add', 'product_add.equip_pdt'])->latest()->take(2)->get();
        ...
        return view('admin.dashboard.index', compact('customer_reviews', 'task2', 'taskHistoryArray'));
    }
}
